# Fruit.create!([
#   {name: "Mango", price: "2.69", description: "Sweet, tender tropical fruit with colorful skin and juicy, fibrous orange flesh", availability: true, supplier_id: 1},
#   {name: "Blueberry", price: "4.99", description: "delightful indigo-colored berry with mysterious, bold flavor.", availability: true, supplier_id: 5},
#   {name: "Raspberry", price: "5.99", description: "soft red berry with delightful, delicate texture", availability: true, supplier_id: 5},
#   {name: "Papaya", price: "1.49", description: "Tropical fruit with colorful skin and black seeds", availability: true, supplier_id: 1},
#   {name: "apple", price: "1.29", description: "Crunchy red fruit with sweet, tart flavor", availability: true, supplier_id: 2},
#   {name: "banana", price: "0.3", description: "long, peelable yellow fruit with soft, sweet, mellow interior", availability: true, supplier_id: 3},
#   {name: "Watermelon", price: "3.99", description: "juicy melon with red flesh", availability: true, supplier_id: 4},
#   {name: "Starfruit", price: "1.49", description: "Fresh, crispy fruit with star-shaped slices", availability: true, supplier_id: 4},
#   {name: "Peach", price: "0.49", description: "Fragrant, delicious pink fruit with fuzzy exterior", availability: true, supplier_id: 4},
#   {name: "Lychee", price: "4.89", description: "small, sweet, juicy, white fruit in rough, peelable shell", availability: true, supplier_id: 4},
#   {name: "Honeydew", price: "2.99", description: "sweet, tender melon with light green yellow flesh", availability: true, supplier_id: 4},
#   {name: "Logan Berry", price: "6.99", description: "Long hexaploid berry with burgundy color", availability: true, supplier_id: 5},
#   {name: "pineapple", price: "2.99", description: "Tropical fruit with juicy, tangy flavor", availability: true, supplier_id: 1},
#   {name: "pear", price: "0.79", description: "Soft, juicy green fruit with sweet, mellow flavor", availability: true, supplier_id: 4},
#   {name: "orange", price: "0.99", description: "round orange fruit with sweet, tangy, juicy sections", availability: true, supplier_id: 4},
#   {name: "cantaloupe", price: "3.5", description: "fragrant, juicy orange-fleshed melon with rough exterior", availability: true, supplier_id: 4},
#   {name: "grapes", price: "4.29", description: "Delicious purple fruits in bunches, grown on the vine.", availability: true, supplier_id: 4},
#   {name: "Plantain", price: "0.59", description: "Larger, milder version of a banana", availability: true, supplier_id: 3}
# ])
# Image.create!([
